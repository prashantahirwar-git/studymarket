...
def upload():
    ...
    if request.method == "POST":
        ...
        # Optional preview image validation
        preview_url = None
        if preview_obj and preview_obj.filename:
            preview_ext = preview_obj.filename.rsplit(".", 1)[-1].lower() if "." in preview_obj.filename else ""
        ...
        if preview_obj and preview_obj.filename:
            try:
                ...
                # Main file already uploaded — still create the product, just without preview
